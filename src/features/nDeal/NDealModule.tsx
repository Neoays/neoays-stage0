...
interface NDealModuleProps {
    profileData: UserProfile;
    onUpdateProfile: (updates: Partial<UserProfile>) => Promise<void>;
    isStandalone?: boolean;
}

const NDealModule: React.FC<NDealModuleProps> = ({ profileData, onUpdateProfile, isStandalone = false }) => {
    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            console.error("Error creating nDeal voucher:", error);
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-4xl font-black tracking-tighter">nDeal</h1>
                    </div>
                    <p className="text-lg font-medium opacity-95 max-w-xl leading-relaxed">
                        Boost conversions with nDeal – the simplest way to create and deliver vouchers.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <h3 className="font-bold text-slate-900 mb-2">My Vouchers</h3>
                        <p className="text-xs text-slate-500 mb-4">Manage your active vouchers, gift cards, and special offers.</p>
                    ...
                    {isAdding ? (
                        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 animate-fade-in-up">
                            <div className="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
                                <h3 className="font-black text-lg text-slate-900">Create New Voucher</h3>
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    {isSaving ? 'Creating Voucher...' : 'Publish Voucher'}
                                </button>
                            </div>
                        </div>
                    ) : (
                        <div className="space-y-3">
                            {(profileData.vouchers || []).length === 0 ? (
                                <div className="text-center py-12 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                                    ...
                                    <p className="text-slate-500 font-medium text-sm">No vouchers yet.</p>
                                    <button onClick={() => setIsAdding(true)} className="mt-2 text-emerald-600 font-bold text-sm hover:underline">Create your first voucher</button>
                                </div>
                            ) : (
